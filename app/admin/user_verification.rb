      ...
      column do
        panel "User Details" do
          attributes_table_for user_verification.user do
            ...
            row :document_type do
              user_verification.user.document_type_name
            end
            row :document_vatid
            row :born_at
            row :email
          ...
          panel "Votos" do
            if user_verification.user.votes.any?
              table_for user_verification.user.votes do
                column :election
                column :voter_id
                column :created_at
              end
          ...
          if !user_verification.user.participation_team_at.nil?

            panel "Equipos de Acción Participativa" do
              if user_verification.user.participation_team.any?
                table_for verification.user.participation_team do
                  column :name
                  column :active
                end
