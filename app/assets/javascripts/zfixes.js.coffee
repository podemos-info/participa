...
born_at_format = () ->
  if ( $('#select2-chosen-3').html() == ".col-xs-3" )
    $('#select2-chosen-3').html('día')
  if ( $('#select2-chosen-4').html() == ".col-xs-5" )
    $('#select2-chosen-4').html('mes')
  if ( $('#select2-chosen-5').html() == ".col-xs-4" )
    $('#select2-chosen-5').html('año')
